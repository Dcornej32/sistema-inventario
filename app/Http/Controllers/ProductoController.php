...
class ProductoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($buscar == '') {
            ...
            'productos.nombre', 'categorias.nombre as nombre_categoria','productos.precio_venta',
            'productos.stock','productos.descripcion','productos.condicion','productos.idcategoria')
