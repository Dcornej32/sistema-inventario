                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Precio_venta</label>
                                    <div class="col-md-9">
    ...
    export default {
        ...
        // METODO DE VALIDAR 
            validarProducto(){
                ...
                if (!this.precio_venta) this.errorMostrarMsjProducto.push("El precio de venta del producto,debe ser un numero y no puede estar vacio.");
